...
/**
 * @ORM\Entity(repositoryClass="AltezzaTravelBundle\Repository\TypeDepartmentRepository")
 * @ORM\Table(name="type_department")
 */
class TypeDepartment
{
     ...
     * @ORM\OneToMany(targetEntity="AltezzaTravelBundle\Entity\HotelContact", mappedBy="department")
     */
    private $hotels;
